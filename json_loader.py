...
class JsonHandler():
    ...
    def load_labels(self) -> None:
        ...
        with open(join_paths(self.dirs.base_dir, "info.json"), "r") as f:
            a = load(f)
        ...
        # Обновляет json файл
        with open(join_paths(self.dirs.base_dir, "info.json"), "w") as f:
    ...
    #     with open(join_paths(self.dirs.baseDir, "info.json"), "r") as f:
    #         a = load(f)
    #         a["parameters"] = {"left": v[0], "right": v[1], "seat": v[2]}

    #     with open(join_paths(self.dirs.baseDir, "info.json"), "w") as f:
    #         dump(a, f, ensure_ascii=False, indent=4)
